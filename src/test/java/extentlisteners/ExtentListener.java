...
public class ExtentListener implements ITestListener {
	...
	public static ExtentReports extentReport = ExtentManager
	...
	public void onTestSuccess(ITestResult result) {
		...
		String markupText = "<b>" + "TestCase:  " + methodName.toUpperCase() + "  Passed!" + "</b>";
		Markup m = MarkupHelper.createLabel(markupText, ExtentColor.CYAN);
